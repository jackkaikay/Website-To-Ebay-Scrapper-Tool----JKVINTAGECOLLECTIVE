...
def product_available(link):
    ...
    if not soup:
        return False
    if soup.find('button', {'class': 'ProductForm__AddToCart Button Button--secondary Button--full'}).text.strip().lower().__contains__('sold out'):
        return False
    return True
...
if __name__ == "__main__":
    input_file = r"C:\Users\jackk\Desktop\GITHUB\EbayScraper\Vintage Club Scraper & Checker\OutputCheck.xlsx"
